...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to MaxiAi. Once setup, you will be able
        to ask questions to MaxiAi directly from Slack. Additionally, you can:
      </Text>

      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup MaxiAiBot to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets MaxiAiBot should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message MaxiAiBot to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
      ...
      <Text className="mb-6">
        ...
        <a
          ...
          href="https://docshub.maxiai.co.za/slack_bot_setup"
          target="_blank"
        >
          guide{" "}
        </a>
        found in the MaxiAi documentation to get started!
      </Text>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup MaxiAiBot</Title>
          <Text className="mb-3">
            Configure MaxiAi to automatically answer questions in Slack
            channels. By default, MaxiAi only responds in channels where a
