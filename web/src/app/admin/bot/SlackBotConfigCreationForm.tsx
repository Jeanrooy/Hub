        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating MaxiAiBot config - ${errorMsg}`
                  : `Error creating MaxiAiBot config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
          ...
          {({ isSubmitting, values }) => (
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add MaxiAiBot to the
                ...
                <SectionHeader>When should MaxiAiBot respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @MaxiAiBot Only"
                  subtext="If set, MaxiAiBot will only respond when directly tagged"
                />
                <BooleanFormField
                  name="respond_to_bots"
                  label="Responds to Bot messages"
                  subtext="If not set, MaxiAiBot will always ignore messages from Bots"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, MaxiAiBot responses will only be 
                  visible to members in this list. This is
                  useful if you want MaxiAiBot to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of MaxiAiBot's response / throw 
                ...
                <BooleanFormField
                  ...
                  label="Should MaxiAi give a “Still need help?” button?"
                  subtext={`If specified, MaxiAiBot's response will include a button at the bottom 
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;MaxiAi Team&apos; or
                        &apos;danswer-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents MaxiAiBot uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that MaxiAiBot should search
                                through. If left blank, MaxiAiBot will search
