...
export function useDocumentSelection(): [
  MaxiAiDocument[],
  (document: MaxiAiDocument) => void,
  () => void,
  number,
] {
  const [selectedDocuments, setSelectedDocuments] = useState<MaxiAiDocument[]>(
    []
  );
  ...
  function toggleDocumentSelection(document: MaxiAiDocument) {
