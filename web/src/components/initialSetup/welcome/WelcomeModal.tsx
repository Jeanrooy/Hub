      ...
      body = (
        <>
          ...
          <div className="mt-3">
            ...
            <div>
              <p>
                Connectors are the way that MaxiAi gets data from your
                organization&apos;s various data sources. Once setup, we&apos;ll
                automatically sync data from your apps and docs into MaxiAi, so
    ...
    case "chat":
      ...
      body = (
        <>
          ...
          <div className="mt-3">
            <div>
              To start using MaxiAi as a secure ChatGPT, we just need to
              configure our LLM!
              <br />
              <br />
              MaxiAi supports connections with a wide range of LLMs, including
      ...
      break;
    default:
      title = "🎉 Welcome to MaxiAi";
      body = (
        <>
          <div>
            <p>How are you planning on using MaxiAi?</p>
          </div>
          <Divider />
          <UsageTypeSection
